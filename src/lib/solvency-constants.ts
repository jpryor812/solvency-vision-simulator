...
export const baselineIncome = [1192.6, 1224.8, 1291.3, 1348.8, 1410.6, 1472.6, 1535.1, 1599.7, 1665.1, 1594.3]; // billions, includes interest
...
export const coeffWageShareEmp = 0.000083; // Δ income per 5 ppt extra wage base (employee side)
